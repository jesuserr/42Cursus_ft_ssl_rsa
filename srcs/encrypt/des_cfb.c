...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/02/12 20:14:12 by jesuserr          #+#    #+#             */
/*   Updated: 2025/02/12 20:59:31 by jesuserr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// block cipher function according CFB. The result is stored in 
// 'args->ciphertext'.
static void	cfb_encrypt_message(t_encrypt_args *args)
{
	uint64_t	i;
	uint8_t		j;
...
static void	des_cfb_encrypt(t_encrypt_args *args)
{
	uint64_t	i;
...
static void	des_cfb_decrypt(t_encrypt_args *args)
{
	uint64_t	i;
	uint8_t		j;
...
// Main function for des-cfb encryption/decryption.
